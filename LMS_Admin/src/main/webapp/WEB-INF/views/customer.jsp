    ...
    <div class="form-container">
        ...
        <div class="form-box">
            <div class="form-part">
             ...
             <div class="form-part" style="display: none;">
                <h2>Nominee Details</h2>
                    ...
                    <b>Nominee Name : </b>
                    <input type="text" name="lnap_nominee" placeholder="Enter Nominee Name"><br>
                    <b>Relation : </b>
                    <input type="text" name="lanp_relation" placeholder="Enter Relation"><br>
            ...
            <div class="form-part" style="display: none;">
                <h2>Loan Details</h2>
               		<b>Amount : </b>
                    <input type="text" name="lnap_amount" placeholder="Enter Amount"><br>
                    <b>Applied Date : </b>
                    <input type="date" name="lnap_apdate" placeholder="Enter Applied Date"><br>
                    <b>Loan Type Id : </b><br>
                    <input type="text" name="lnap_lnty_id" placeholder="Enter Loan Type Id"><br>
                    
                    <b>Emi From Range : </b><br>
                    <input type="tel" name="lnap_emi_range_from" placeholder="Enter Emi From Range"><br>
                    <b>Emi to Range : </b>
                    <input type="text" name="lnap_emi_range_to" placeholder="Enter Emi to Range"><br>
                   
                    <b>Cibil Score : </b>
                    <input type="text" name="lnap_cibil_Score" placeholder="Enter Cibil Score"><br>
